...
from virutis.utils import misc
from virutis.utils import error_checks
...
def get_defaults(config):
    ...
    config["reference_directory"] = pkg_resources.resource_filename('virutis', 'resources')
...
def set_up_reference_directory(config):
    ...
    if reference_directory != pkg_resources.resource_filename('virutis', 'resources'):
